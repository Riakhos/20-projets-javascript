...
Pour cela, il faut utiliser **l'élément \<canvas>** qui permet de **dessiner** sur une page en JavaScript.
On l'associe à la méthode **requestAnimationFrame(callback)**, qui permet d'appeler une fonction de rappel au mieux **60 fois par seconde**, permettant ainsi de déplacer les éléments du \<canvas> et de donner une **illusion de mouvement.**
...
> Au début de chaque projet, codez seulement une interface basique du projet à réaliser, en ajoutant un peu de style si besoin est.
...
6. Gérer le **responsive** en **relançant** l'animation du canvas lors du **redimensionnement** de la fenêtre.
